...
proc setModuleDataLayout*(
  m: ModuleRef, dl: TargetDataRef
) {.importc: "LLVMSetModuleDataLayout", dynlib: LLVMLib.}

##  Creates target data from a target layout string.
##     See the constructor llvm::DataLayout::DataLayout.

proc createTargetData*(
  stringRep: cstring
): TargetDataRef {.importc: "LLVMCreateTargetData", dynlib: LLVMLib.}

##  Deallocates a TargetData.
##     See the destructor llvm::DataLayout::~DataLayout.

proc disposeTargetData*(
  td: TargetDataRef
) {.importc: "LLVMDisposeTargetData", dynlib: LLVMLib.}

##  Adds target library information to a pass manager. This does not take
##     ownership of the target library info.
##     See the method llvm::PassManagerBase::add.

proc addTargetLibraryInfo*(
...
proc copyStringRepOfTargetData*(
  td: TargetDataRef
): cstring {.importc: "LLVMCopyStringRepOfTargetData", dynlib: LLVMLib.}
...
proc byteOrder*(
  td: TargetDataRef
): ByteOrdering {.importc: "LLVMByteOrder", dynlib: LLVMLib.}
...
proc pointerSize*(
  td: TargetDataRef
): cuint {.importc: "LLVMPointerSize", dynlib: LLVMLib.}

##  Returns the pointer size in bytes for a target for a specified
##     address space.
##     See the method llvm::DataLayout::getPointerSize.

proc pointerSizeForAS*(
  td: TargetDataRef, `as`: cuint
): cuint {.importc: "LLVMPointerSizeForAS", dynlib: LLVMLib.}
...
proc intPtrTypeInContext*(
  c: ContextRef, td: TargetDataRef
): TypeRef {.importc: "LLVMIntPtrTypeInContext", dynlib: LLVMLib.}

##  Returns the integer type that is the same size as a pointer on a target.
##     This version allows the address space to be specified.
##     See the method llvm::DataLayout::getIntPtrType.

proc intPtrTypeForASInContext*(
...
): culonglong {.importc: "LLVMSizeOfTypeInBits", dynlib: LLVMLib.}

##  Computes the storage size of a type in bytes for a target.
##     See the method llvm::DataLayout::getTypeStoreSize.

proc storeSizeOfType*(
  td: TargetDataRef, ty: TypeRef
): culonglong {.importc: "LLVMStoreSizeOfType", dynlib: LLVMLib.}
...
proc aBISizeOfType*(
  td: TargetDataRef, ty: TypeRef
): culonglong {.importc: "LLVMABISizeOfType", dynlib: LLVMLib.}

##  Computes the ABI alignment of a type in bytes for a target.
##     See the method llvm::DataLayout::getTypeABISize.

proc aBIAlignmentOfType*(
  td: TargetDataRef, ty: TypeRef
): cuint {.importc: "LLVMABIAlignmentOfType", dynlib: LLVMLib.}

##  Computes the call frame alignment of a type in bytes for a target.
##     See the method llvm::DataLayout::getTypeABISize.

proc callFrameAlignmentOfType*(
  td: TargetDataRef, ty: TypeRef
): cuint {.importc: "LLVMCallFrameAlignmentOfType", dynlib: LLVMLib.}

##  Computes the preferred alignment of a type in bytes for a target.
##     See the method llvm::DataLayout::getTypeABISize.

proc preferredAlignmentOfType*(
  td: TargetDataRef, ty: TypeRef
): cuint {.importc: "LLVMPreferredAlignmentOfType", dynlib: LLVMLib.}

##  Computes the preferred alignment of a global variable in bytes for a target.
##     See the method llvm::DataLayout::getPreferredAlignment.

proc preferredAlignmentOfGlobal*(
  td: TargetDataRef, globalVar: ValueRef
): cuint {.importc: "LLVMPreferredAlignmentOfGlobal", dynlib: LLVMLib.}

##  Computes the structure element that contains the byte offset for a target.
##     See the method llvm::StructLayout::getElementContainingOffset.

proc elementAtOffset*(
  td: TargetDataRef, structTy: TypeRef, offset: culonglong
): cuint {.importc: "LLVMElementAtOffset", dynlib: LLVMLib.}

##  Computes the byte offset of the indexed struct element for a target.
##     See the method llvm::StructLayout::getElementContainingOffset.

proc offsetOfElement*(
  td: TargetDataRef, structTy: TypeRef, element: cuint
): culonglong {.importc: "LLVMOffsetOfElement", dynlib: LLVMLib.}
