...
type
  MemoryManagerAllocateCodeSectionCallback* = proc (opaque: pointer;
      size: uint; alignment: cuint; sectionID: cuint; sectionName: cstring): ptr uint8
  MemoryManagerAllocateDataSectionCallback* = proc (opaque: pointer;
      size: uint; alignment: cuint; sectionID: cuint; sectionName: cstring;
      isReadOnly: Bool): ptr uint8
