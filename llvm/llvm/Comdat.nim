...
type ComdatSelectionKind* {.size: sizeof(cint).} = enum
...
proc getOrInsertComdat*(
  m: ModuleRef, name: cstring
): ComdatRef {.importc: "LLVMGetOrInsertComdat", dynlib: LLVMLib.}
...
proc getComdatSelectionKind*(
  c: ComdatRef
): ComdatSelectionKind {.importc: "LLVMGetComdatSelectionKind", dynlib: LLVMLib.}
...
proc setComdatSelectionKind*(
  c: ComdatRef, kind: ComdatSelectionKind
