...
type                          # Terminator Instructions 
  ...
  Attribute* {.size: sizeof(cint).} = enum 
    ...
    Alignment = 31 shl 16, NoCaptureAttribute = 1 shl 21, 
    NoRedZoneAttribute = 1 shl 22, NoImplicitFloatAttribute = 1 shl 23, 
    NakedAttribute = 1 shl 24, InlineHintAttribute = 1 shl 25, 
    StackAlignment = 7 shl 26, ReturnsTwice = 1 shl 29, UWTable = 1 shl 30, 
  ...
  Opcode* {.size: sizeof(cint).} = enum 
    ...
    Add = 8, FAdd = 9, Sub = 10, FSub = 11, Mul = 12, FMul = 13, UDiv = 14, 
    SDiv = 15, FDiv = 16, URem = 17, SRem = 18, FRem = 19, # Logical Operators 
    ...
    SIToFP = 36, FPTrunc = 37, FPExt = 38, PtrToInt = 39, IntToPtr = 40, 
    BitCast = 41, ICmp = 42, FCmp = 43, PHI = 44, Call = 45, Select = 46, 
    UserOp1 = 47, UserOp2 = 48, VAArg = 49, ExtractElement = 50, 
...
proc getAsString*(c: ValueRef; `out`: ptr csize): cstring {.
...
proc constGEP*(constantVal: ValueRef; constantIndices: ptr ValueRef; 
               numIndices: cuint): ValueRef {.importc: "LLVMConstGEP", 
    dynlib: LLVMLib.}
...
proc addFunctionAttr*(fn: ValueRef; pa: Attribute) {.
    importc: "LLVMAddFunctionAttr", dynlib: LLVMLib.}
#*
...
proc removeAttribute*(arg: ValueRef; pa: Attribute) {.
    importc: "LLVMRemoveAttribute", dynlib: LLVMLib.}
#*
...
proc buildBr*(a2: BuilderRef; dest: BasicBlockRef): ValueRef {.
...
proc buildCondBr*(a2: BuilderRef; `if`: ValueRef; then: BasicBlockRef; 
    ...
    dynlib: LLVMLib.}
proc buildSwitch*(a2: BuilderRef; v: ValueRef; `else`: BasicBlockRef; 
...
proc buildInvoke*(a2: BuilderRef; fn: ValueRef; args: ptr ValueRef; 
                  numArgs: cuint; then: BasicBlockRef; catch: BasicBlockRef; 
                  name: cstring): ValueRef {.importc: "LLVMBuildInvoke", 
    dynlib: LLVMLib.}
...
proc buildUnreachable*(a2: BuilderRef): ValueRef {.
...
proc buildGEP*(b: BuilderRef; pointer: ValueRef; indices: ptr ValueRef; 
    ...
    importc: "LLVMBuildGEP", dynlib: LLVMLib.}
...
proc buildPtrToInt*(a2: BuilderRef; val: ValueRef; destTy: TypeRef; 
                    name: cstring): ValueRef {.importc: "LLVMBuildPtrToInt", 
    dynlib: LLVMLib.}
proc buildIntToPtr*(a2: BuilderRef; val: ValueRef; destTy: TypeRef; 
...
proc buildAddrSpaceCast*(a2: BuilderRef; val: ValueRef; destTy: TypeRef; 
                         name: cstring): ValueRef {.
    importc: "LLVMBuildAddrSpaceCast", dynlib: LLVMLib.}
proc buildZExtOrBitCast*(a2: BuilderRef; val: ValueRef; destTy: TypeRef; 
                         name: cstring): ValueRef {.
    importc: "LLVMBuildZExtOrBitCast", dynlib: LLVMLib.}
proc buildSExtOrBitCast*(a2: BuilderRef; val: ValueRef; destTy: TypeRef; 
                         name: cstring): ValueRef {.
    importc: "LLVMBuildSExtOrBitCast", dynlib: LLVMLib.}
proc buildTruncOrBitCast*(a2: BuilderRef; val: ValueRef; destTy: TypeRef; 
                          name: cstring): ValueRef {.
...
proc buildCast*(b: BuilderRef; op: Opcode; val: ValueRef; destTy: TypeRef; 
    ...
    dynlib: LLVMLib.}
proc buildPointerCast*(a2: BuilderRef; val: ValueRef; destTy: TypeRef; 
                       name: cstring): ValueRef {.
...
proc buildCall*(a2: BuilderRef; fn: ValueRef; args: ptr ValueRef; 
                numArgs: cuint; name: cstring): ValueRef {.
    importc: "LLVMBuildCall", dynlib: LLVMLib.}
proc buildSelect*(a2: BuilderRef; `if`: ValueRef; then: ValueRef; 
...
proc buildShuffleVector*(a2: BuilderRef; v1: ValueRef; v2: ValueRef; 
                         mask: ValueRef; name: cstring): ValueRef {.
    importc: "LLVMBuildShuffleVector", dynlib: LLVMLib.}
proc buildExtractValue*(a2: BuilderRef; aggVal: ValueRef; index: cuint; 
                        name: cstring): ValueRef {.
